...
const ServiceCard = ({ title, description, icon: Icon, features, popular }: ServiceCardProps) => {
  const handleGetHelp = () => {
  ...
  return (
    <Card className={`relative bg-gradient-card shadow-card hover:shadow-glow transition-all duration-300 transform hover:-translate-y-1 ${popular ? 'ring-2 ring-primary' : ''}`}>
      {popular && (
