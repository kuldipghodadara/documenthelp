export const documentGuides = {
  "Aadhaar Card Services": {
    overview: "Aadhaar card is a 12-digit unique identification number issued by UIDAI. It serves as proof of identity and address for Indian residents. You can apply for new Aadhaar, update details, or correct information using online and offline methods.",
    timeline: "15-30 days for new enrollment, 7-15 days for updates",
    steps: [
      {
        title: "Visit Aadhaar Center",
        description: "Locate and visit nearest Aadhaar enrollment/update center",
        details: [
      ...
      },
      {
        ...
        description: "Complete the enrollment/update form with accurate details",
        details: [
      ...
      },
      {
        ...
        description: "Submit required documents for identity, address, and date of birth proof",
        details: [
    ...
    documents: [
      {
        ...
        items: [
          ...
          "Bank Passbook with Photo", "Government ID Card", 
          "Ration Card with Photo", "Marriage Certificate"
        ]
      },
      {
        category: "Address Proof (Any One)", 
        items: [
          "Passport", "Bank Statement", "Post Office Account Statement",
          "Ration Card", "Voter ID", "Driving License", "Utility Bills",
          "Property Tax Receipt", "Insurance Policy", "Rent Agreement"
        ]
      },
      {
        category: "Date of Birth Proof (Any One)",
        items: [
          "Birth Certificate", "Passport", "Marksheet (Class 10/12)",
          "PAN Card", "Driving License", "Government ID with DOB",
          "Insurance Policy", "LIC Policy Bond"
        ]
      }
    ],
    forms: [
  ...
  "Voter ID Card": {
    overview: "Voter ID card (EPIC) is an identity document issued by Election Commission of India. It's required for voting in elections and serves as a valid ID proof. You can apply online through NVSP portal or visit local election office.",
    ...
    steps: [
      ...
      },
      {
        ...
        description: "Electoral Registration Officer verifies submitted information",
        details: [
    ...
    documents: [
      {
        ...
        items: [
          ...
          "Bank Passbook with Photo", "Service ID Card", 
          "Pensioner Card", "Arms License"
        ]
      },
      {
        category: "Address Proof (Any One)",
        items: [
          "Aadhaar Card", "Passport", "Bank Statement", "Utility Bills",
          "Ration Card", "Property Documents", "Rent Agreement",
      ...
      },
      {
        ...
        items: [
          "Birth Certificate", "Passport", "Marksheet (10th/12th)",
          "Aadhaar Card", "Driving License", "PAN Card"
        ]
      }
    ],
    forms: [
  ...
  "Passport Services": {
    overview: "Indian passport is issued by Ministry of External Affairs through Passport Seva. It's essential for international travel and serves as a primary identity document. Applications can be submitted online through Passport Seva portal.",
    ...
    documents: [
      {
        ...
        items: [
          ...
          "Government Employee ID", "PSU Employee ID"
        ]
      },
      {
        category: "Address Proof (Any One)",
        items: [
          "Aadhaar Card", "Voter ID", "Utility Bills", "Bank Statement",
          "Rent Agreement", "Property Tax Receipt", "Telephone Bill"
        ]
      },
      {
        category: "Date of Birth Proof (Any One)",
        items: [
          "Birth Certificate", "Marksheet (10th/12th)", "Aadhaar Card",
          "PAN Card", "Driving License", "Medical Certificate"
        ]
      }
    ],
    forms: [
  ...
  "Driving License": {
    overview: "Driving License is issued by Regional Transport Office (RTO) after passing driving test. You need Learner's License first, then permanent DL. International Driving Permit can be obtained for overseas driving.",
    ...
    documents: [
      {
        category: "Identity Proof (Any One)",
        items: [
          "Aadhaar Card", "Passport", "Voter ID", "PAN Card",
          "Bank Passbook with Photo", "Government ID Card"
        ]
      },
      {
        category: "Address Proof (Any One)",
        items: [
          "Aadhaar Card", "Passport", "Voter ID", "Utility Bills",
          "Bank Statement", "Ration Card", "Rent Agreement"
        ]
      },
      {
        category: "Age Proof (Any One)",
        items: [
          "Birth Certificate", "Marksheet (10th/12th)", "Passport",
          "Aadhaar Card", "Medical Certificate"
        ]
      }
    ],
    forms: [
  ...
  "Ration Card": {
    overview: "Ration Card is issued under Public Distribution System (PDS) to provide subsidized food grains and other commodities. It also serves as address and identity proof. Applications are processed by state Food & Civil Supplies departments.",
    ...
    documents: [
      {
        ...
        items: [
          ...
          "Driving License", "Bank Passbook with Photo"
        ]
      },
      {
        category: "Address Proof (Any One)",
        items: [
          "Aadhaar Card", "Voter ID", "Utility Bills", "Property Documents",
          "Rent Agreement", "Bank Statement", "Telephone Bill"
        ]
      },
      {
        category: "Income Proof",
        items: [
          "Salary Certificate", "Income Certificate from Tehsildar",
          "ITR/Form 16", "Bank Statement", "Pension Certificate",
  ...
  "Scholarship Forms": {
    overview: "Government and private scholarships support students' education based on merit, need, or category. Applications are submitted through respective portals like National Scholarship Portal, state portals, or institution-specific systems.",
    ...
    documents: [
      {
        ...
        items: [
          "10th/12th Marksheets", "Graduation/PG Certificates",
          "Current Year Admission Receipt", "Fee Receipt/Structure",
      ...
      },
      {
        ...
        items: [
          ...
          "Caste Certificate (if applicable)", "Domicile Certificate",
      ...
      },
      {
        ...
        items: [
          "Disability Certificate", "Single Girl Child Certificate",
          "Minority Certificate", "EWS Certificate",
